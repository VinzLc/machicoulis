...
import { createDailyClaim } from "../graphql/mutations";
const client = generateClient();
export default function DailyClaimCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setClaimDate(initialValues.claimDate);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDailyClaim.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DailyClaimCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
